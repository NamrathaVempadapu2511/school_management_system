...
if ($row=$output->num_rows==1){
    $student_query = "Update fee_details set Roll_no = '$Roll_no', First_term = '$First_term', Second_term = '$Second_term', Third_term = '$Third_term', Created_time = '$Created_time' WHERE Roll_no = '$Roll_no'";
